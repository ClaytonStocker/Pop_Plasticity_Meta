...
mode_abs_b_plastic_acc <- posterior.mode(as.mcmc(b_abs_plastic_acc))
mode_abs_b_plastic_dev <- posterior.mode(as.mcmc(b_abs_plastic_dev))
mode_abs_b_plastic_trans <- posterior.mode(as.mcmc(b_abs_plastic_trans))
...
# Moderator Differences
dev_acc <- as.mcmc(b_abs_plastic_dev - b_abs_plastic_acc)
dev_acc_mode <- posterior.mode(dev_acc)
dev_acc_perc <- round(posterior.mode(exp(dev_acc)-1)*100, 2)
dev_acc_ci <- HPDinterval(dev_acc)
dev_acc_p <- 2*(1-max(table(dev_acc<0)/length(dev_acc)))

dev_trans <- as.mcmc(b_abs_plastic_dev - b_abs_plastic_trans)
dev_trans_mode <- posterior.mode(dev_trans)
dev_trans_perc <- round(posterior.mode(exp(dev_trans)-1)*100, 2)
dev_trans_ci <- HPDinterval(dev_trans)
dev_trans_p <- 2*(1-max(table(dev_trans<0)/length(dev_trans)))
...
overall_plastic_modes_list <- c(mode_abs_b_plastic_acc, mode_abs_b_plastic_dev, mode_abs_b_plastic_trans)
...
overall_plastic_summary <- matrix(c(overall_plastic_modes_list, overall_plastic_low_ci, overall_plastic_high_ci), 
                                  nrow = 3, ncol = 3, byrow = FALSE, 
                                  dimnames = list(c(overall_plastic_categories), 
                                                  c("Mode", "Low_CI", "High_CI")))
...
Plasticity_table <- data.frame(estimate = overall_plastic_summary[,"Mode"], 
...
density_plasticity <- Plasticity_table %>% mutate(name = fct_relevel(name, Plasticity_Order)) %>%
                      ...
                      geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_plastic_trans))-1)*100, 2), nsmall = 2), "%"), 
                                             paste(format(round(posterior.mode(exp(as.mcmc(b_abs_plastic_dev))-1)*100, 2), nsmall = 2), "%"),
...
Plasticity_table_1 <- data.frame(estimate = overall_plastic_summary_Reorder_1[,"Mode"], 
...
density_plasticity_1 <- Plasticity_table_1 %>% mutate(name = fct_relevel(name, Plasticity_Order_1)) %>%
                        ...
                        geom_linerange(aes(y = rev(seq(1, dim(Plasticity_table_1)[1], 1)), xmin = max(Plasticity_raw_df_1$Effect)+0.001, xmax = 1.5, colour = name),
                                       size = 1) +
                        geom_linerange(aes(y = rev(seq(1, dim(Plasticity_table_1)[1], 1)), xmin = min(Plasticity_raw_df_1$Effect), xmax = -0.2, colour = name),
                                       size = 1) +
                        ...
                        label= paste("italic(k)==", c(Plasticity_table_1["Developmental Plasticity", "K"], 
                                     ...
                                     ")"), parse = TRUE, hjust = "right", size = 3.5) +
                        geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_plastic_dev))-1)*100, 2), nsmall = 2), "%"),
                                               paste(format(round(posterior.mode(exp(as.mcmc(b_abs_plastic_acc))-1)*100, 2), nsmall = 2), "%")), 
...
Plasticity_table_2 <- data.frame(estimate = overall_plastic_summary_Reorder_2[,"Mode"], 
...
mode_abs_b_trait_behavioural <- posterior.mode(as.mcmc(b_abs_trait_behavioural))
mode_abs_b_trait_biochem <- posterior.mode(as.mcmc(b_abs_trait_biochem))
mode_abs_b_trait_gene <- posterior.mode(as.mcmc(b_abs_trait_gene))
mode_abs_b_trait_life <- posterior.mode(as.mcmc(b_abs_trait_life))
mode_abs_b_trait_morphology <- posterior.mode(as.mcmc(b_abs_trait_morphology))
mode_abs_b_trait_physiological <- posterior.mode(as.mcmc(b_abs_trait_physiological))
mode_abs_b_trait_tolerance <- posterior.mode(as.mcmc(b_abs_trait_tolerance))
...
# Moderator Differences
morph_bio <- as.mcmc(b_abs_trait_morphology - b_abs_trait_biochem)
morph_bio_mode <- posterior.mode(morph_bio)
morph_bio_perc <- round(posterior.mode(exp(morph_bio)-1)*100, 2)
morph_bio_ci <- HPDinterval(morph_bio)
morph_bio_p <- 2*(1-max(table(morph_bio<0)/length(morph_bio)))

morph_tol <- as.mcmc(b_abs_trait_morphology - b_abs_trait_tolerance)
morph_tol_mode <- posterior.mode(morph_tol)
morph_tol_perc <- round(posterior.mode(exp(morph_tol)-1)*100, 2)
morph_tol_ci <- HPDinterval(morph_tol)
morph_tol_p <- 2*(1-max(table(morph_tol<0)/length(morph_tol)))

phys_behav <- as.mcmc(b_abs_trait_physiological - b_abs_trait_behavioural)
phys_behav_mode <- posterior.mode(phys_behav)
phys_behav_perc <- round(posterior.mode(exp(phys_behav)-1)*100, 2)
phys_behav_ci <- HPDinterval(phys_behav)
phys_behav_p <- 2*(1-max(table(phys_behav<0)/length(phys_behav)))

phys_bio <- as.mcmc(b_abs_trait_physiological - b_abs_trait_biochem)
phys_bio_mode <- posterior.mode(phys_bio)
phys_bio_perc <- round(posterior.mode(exp(phys_bio)-1)*100, 2)
phys_bio_ci <- HPDinterval(phys_bio)
phys_bio_p <- 2*(1-max(table(phys_bio<0)/length(phys_bio)))

phys_gene <- as.mcmc(b_abs_trait_physiological - b_abs_trait_gene)
phys_gene_mode <- posterior.mode(phys_gene)
phys_gene_perc <- round(posterior.mode(exp(phys_gene)-1)*100, 2)
phys_gene_ci <- HPDinterval(phys_gene)
phys_gene_p <- 2*(1-max(table(phys_gene<0)/length(phys_gene)))

phys_life <- as.mcmc(b_abs_trait_physiological - b_abs_trait_life)
phys_life_mode <- posterior.mode(phys_life)
phys_life_perc <- round(posterior.mode(exp(phys_life)-1)*100, 2)
phys_life_ci <- HPDinterval(phys_life)
phys_life_p <- 2*(1-max(table(phys_life<0)/length(phys_life)))

phys_morph <- as.mcmc(b_abs_trait_physiological - b_abs_trait_morphology)
phys_morph_mode <- posterior.mode(phys_morph)
phys_morph_perc <- round(posterior.mode(exp(phys_morph)-1)*100, 2)
phys_morph_ci <- HPDinterval(phys_morph)
phys_morph_p <- 2*(1-max(table(phys_morph<0)/length(phys_morph)))

phys_tol <- as.mcmc(b_abs_trait_physiological - b_abs_trait_tolerance)
phys_tol_mode <- posterior.mode(phys_tol)
phys_tol_perc <- round(posterior.mode(exp(phys_tol)-1)*100, 2)
phys_tol_ci <- HPDinterval(phys_tol)
phys_tol_p <- 2*(1-max(table(phys_tol<0)/length(phys_tol)))
...
overall_trait_modes_list <- c(mode_abs_b_trait_behavioural, mode_abs_b_trait_biochem, mode_abs_b_trait_gene, mode_abs_b_trait_life,
                              mode_abs_b_trait_morphology, mode_abs_b_trait_physiological, mode_abs_b_trait_tolerance)
...
overall_trait_summary <- matrix(c(overall_trait_modes_list, overall_trait_low_ci, overall_trait_high_ci), 
...
Trait_table <- data.frame(estimate = overall_trait_summary_Reorder[,"Mode"], 
...
density_trait <- Trait_table %>% mutate(name = fct_relevel(name, Trait_Order)) %>%
                 ...
                 label= paste("italic(k)==", c(Trait_table["Tolerance", "K"], 
                              ...
                              ")"), parse = TRUE, hjust = "right", size = 3.5) +
                 geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_trait_tolerance))-1)*100, 2), nsmall = 2), "%"), 
                                        paste(format(round(posterior.mode(exp(as.mcmc(b_abs_trait_physiological))-1)*100, 2), nsmall = 2), "%"),
                                        paste(format(round(posterior.mode(exp(as.mcmc(b_abs_trait_morphology))-1)*100, 2), nsmall = 2), "%"), 
                                        paste(format(round(posterior.mode(exp(as.mcmc(b_abs_trait_life))-1)*100, 2), nsmall = 2), "%"), 
                                        paste(format(round(posterior.mode(exp(as.mcmc(b_abs_trait_gene))-1)*100, 2), nsmall = 2), "%"),
                                        paste(format(round(posterior.mode(exp(as.mcmc(b_abs_trait_biochem))-1)*100, 2), nsmall = 2), "%"), 
...
Trait_table_1 <- data.frame(estimate = overall_trait_summary_Reorder_1[,"Mode"], 
...
density_trait_1 <- Trait_table_1 %>% mutate(name = fct_relevel(name, Trait_Order_1)) %>%
                   ...
                   label= paste("italic(k)==", c(Trait_table_1["Life-history Traits", "K"], 
                                ...
                                ")"), parse = TRUE, hjust = "right", size = 3.5) +
                    geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_trait_life))-1)*100, 2), nsmall = 2), "%"), 
                                           paste(format(round(posterior.mode(exp(as.mcmc(b_abs_trait_gene))-1)*100, 2), nsmall = 2), "%"),
                                           paste(format(round(posterior.mode(exp(as.mcmc(b_abs_trait_biochem))-1)*100, 2), nsmall = 2), "%"), 
                                           paste(format(round(posterior.mode(exp(as.mcmc(b_abs_trait_behavioural))-1)*100, 2), nsmall = 2), "%")), 
...
Trait_table_2 <- data.frame(estimate = overall_trait_summary_Reorder_2[,"Mode"], 
...
density_trait_2 <- Trait_table_2 %>% mutate(name = fct_relevel(name, Trait_Order_2)) %>%
                   ...
                   geom_linerange(aes(y = rev(seq(1, dim(Trait_table_2)[1], 1)), xmin = max(Trait_raw_df_2$Effect)+0.001, xmax = 1.5, colour = name),
                                  size = 1) +
                   geom_linerange(aes(y = rev(seq(1, dim(Trait_table_2)[1], 1)), xmin = min(Trait_raw_df_2$Effect)-0.01, xmax = -0.2, colour = name),
                                  size = 1) +
...
mode_abs_b_taxonomy_actinopteri <- posterior.mode(as.mcmc(b_abs_taxonomy_actinopteri))
mode_abs_b_taxonomy_amphibia <- posterior.mode(as.mcmc(b_abs_taxonomy_amphibia))
mode_abs_b_taxonomy_branchiopoda <- posterior.mode(as.mcmc(b_abs_taxonomy_branchiopoda))
mode_abs_b_taxonomy_gastropoda <- posterior.mode(as.mcmc(b_abs_taxonomy_gastropoda))
mode_abs_b_taxonomy_insecta <- posterior.mode(as.mcmc(b_abs_taxonomy_insecta))
...
# Moderator Differences
gastro_actin <- as.mcmc(b_abs_taxonomy_gastropoda - b_abs_taxonomy_actinopteri)
gastro_actin_mode <- posterior.mode(gastro_actin)
gastro_actin_perc <- round(posterior.mode(exp(gastro_actin)-1)*100, 2)
gastro_actin_ci <- HPDinterval(gastro_actin)
gastro_actin_p <- 2*(1-max(table(gastro_actin<0)/length(gastro_actin)))

gastro_amph <- as.mcmc(b_abs_taxonomy_gastropoda - b_abs_taxonomy_amphibia)
gastro_amph_mode <- posterior.mode(gastro_amph)
gastro_amph_perc <- round(posterior.mode(exp(gastro_amph)-1)*100, 2)
gastro_amph_ci <- HPDinterval(gastro_amph)
gastro_amph_p <- 2*(1-max(table(gastro_amph<0)/length(gastro_amph)))

gastro_branch <- as.mcmc(b_abs_taxonomy_gastropoda - b_abs_taxonomy_branchiopoda)
gastro_branch_mode <- posterior.mode(gastro_branch)
gastro_branch_perc <- round(posterior.mode(exp(gastro_branch)-1)*100, 2)
gastro_branch_ci <- HPDinterval(gastro_branch)
gastro_branch_p <- 2*(1-max(table(gastro_branch<0)/length(gastro_branch)))

gastro_insect <- as.mcmc(b_abs_taxonomy_gastropoda - b_abs_taxonomy_insecta)
gastro_insect_mode <- posterior.mode(gastro_insect)
gastro_insect_perc <- round(posterior.mode(exp(gastro_insect)-1)*100, 2)
gastro_insect_ci <- HPDinterval(gastro_insect)
gastro_insect_p <- 2*(1-max(table(gastro_insect<0)/length(gastro_insect)))

# Heterogeneity
overall_i2_taxonomy <- i2(sd_taxonomy, Taxonomy_Data$Variance_Adjusted) 

# Overall_trait_summary
overall_taxonomy_modes_list <- c(mode_abs_b_taxonomy_actinopteri, mode_abs_b_taxonomy_amphibia, mode_abs_b_taxonomy_branchiopoda, 
                                 mode_abs_b_taxonomy_gastropoda, mode_abs_b_taxonomy_insecta)
...
overall_taxonomy_summary <- matrix(c(overall_taxonomy_modes_list, overall_taxonomy_low_ci, overall_taxonomy_high_ci), 
...
Taxonomy_table <- data.frame(estimate = overall_taxonomy_summary[,"Mode"], 
...
density_taxonomy <- Taxonomy_table %>% mutate(name = fct_relevel(name, Taxonomy_Order)) %>%
                    ...
                    label= paste("italic(k)==", c(Taxonomy_table["Insecta", "K"], 
                                 ...
                                 ")"), parse = TRUE, hjust = "right", size = 3.5) +
                    geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_taxonomy_insecta))-1)*100, 2), nsmall = 2), "%"), 
                                           paste(format(round(posterior.mode(exp(as.mcmc(b_abs_taxonomy_gastropoda))-1)*100, 2), nsmall = 2), "%"),
                                           paste(format(round(posterior.mode(exp(as.mcmc(b_abs_taxonomy_branchiopoda))-1)*100, 2), nsmall = 2), "%"), 
                                           paste(format(round(posterior.mode(exp(as.mcmc(b_abs_taxonomy_amphibia))-1)*100, 2), nsmall = 2), "%"), 
...
Taxonomy_table_1 <- data.frame(estimate = overall_taxonomy_summary_Reorder_1[,"Mode"], 
...
density_taxonomy_1 <- Taxonomy_table_1 %>% mutate(name = fct_relevel(name, Taxonomy_Order_1)) %>%
                      ...
                      label= paste("italic(k)==", c(Taxonomy_table_1["Branchiopoda", "K"], 
                                            ...
                                            ")"), parse = TRUE, hjust = "right", size = 3.5) +
                      geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_taxonomy_branchiopoda))-1)*100, 2), nsmall = 2), "%"), 
                                             paste(format(round(posterior.mode(exp(as.mcmc(b_abs_taxonomy_amphibia))-1)*100, 2), nsmall = 2), "%"), 
                                             paste(format(round(posterior.mode(exp(as.mcmc(b_abs_taxonomy_actinopteri))-1)*100, 2), nsmall = 2), "%")), 
...
Taxonomy_table_2 <- data.frame(estimate = overall_taxonomy_summary_Reorder_2[,"Mode"], 
...
density_taxonomy_2 <- Taxonomy_table_2 %>% mutate(name = fct_relevel(name, Taxonomy_Order_2)) %>%
                      ...
                      geom_linerange(aes(y = rev(seq(1, dim(Taxonomy_table_2)[1], 1)), xmin = max(Taxonomy_raw_df_2$Effect)+0.001, xmax = 1.5, colour = name),
                                     size = 1) +
                      geom_linerange(aes(y = rev(seq(1, dim(Taxonomy_table_2)[1], 1)), xmin = min(Taxonomy_raw_df_2$Effect)-0.01, xmax = -0.2, colour = name),
                                     size = 1) +
...
mode_abs_b_treatment_diet <- posterior.mode(as.mcmc(b_abs_treatment_diet))
mode_abs_b_treatment_humidity <- posterior.mode(as.mcmc(b_abs_treatment_humidity))
mode_abs_b_treatment_predator <- posterior.mode(as.mcmc(b_abs_treatment_predator))
mode_abs_b_treatment_salinity <- posterior.mode(as.mcmc(b_abs_treatment_salinity))
mode_abs_b_treatment_temperature <- posterior.mode(as.mcmc(b_abs_treatment_temperature))
mode_abs_b_treatment_waterlevel <- posterior.mode(as.mcmc(b_abs_treatment_waterlevel))
...
# Moderator Differences
humid_diet <- as.mcmc(b_abs_treatment_humidity - b_abs_treatment_diet)
humid_diet_mode <- posterior.mode(humid_diet)
humid_diet_perc <- round(posterior.mode(exp(humid_diet)-1)*100, 2)
humid_diet_ci <- HPDinterval(humid_diet)
humid_diet_p <- 2*(1-max(table(humid_diet<0)/length(humid_diet)))

humid_pred <- as.mcmc(b_abs_treatment_humidity - b_abs_treatment_predator)
humid_pred_mode <- posterior.mode(humid_pred)
humid_pred_perc <- round(posterior.mode(exp(humid_pred)-1)*100, 2)
humid_pred_ci <- HPDinterval(humid_pred)
humid_pred_p <- 2*(1-max(table(humid_pred<0)/length(humid_pred)))

humid_sal <- as.mcmc(b_abs_treatment_humidity - b_abs_treatment_salinity)
humid_sal_mode <- posterior.mode(humid_sal)
humid_sal_perc <- round(posterior.mode(exp(humid_sal)-1)*100, 2)
humid_sal_ci <- HPDinterval(humid_sal)
humid_sal_p <- 2*(1-max(table(humid_sal<0)/length(humid_sal)))

humid_temp <- as.mcmc(b_abs_treatment_humidity - b_abs_treatment_temperature)
humid_temp_mode <- posterior.mode(humid_temp)
humid_temp_perc <- round(posterior.mode(exp(humid_temp)-1)*100, 2)
humid_temp_ci <- HPDinterval(humid_temp)
humid_temp_p <- 2*(1-max(table(humid_temp<0)/length(humid_temp)))

humid_water <- as.mcmc(b_abs_treatment_humidity - b_abs_treatment_waterlevel)
humid_water_mode <- posterior.mode(humid_water)
humid_water_perc <- round(posterior.mode(exp(humid_water)-1)*100, 2)
humid_water_ci <- HPDinterval(humid_water)
humid_water_p <- 2*(1-max(table(humid_water<0)/length(humid_water)))
...
overall_treatment_modes_list <- c(mode_abs_b_treatment_diet, mode_abs_b_treatment_humidity, mode_abs_b_treatment_predator, 
                                  mode_abs_b_treatment_salinity, mode_abs_b_treatment_temperature, mode_abs_b_treatment_waterlevel)
...
overall_treatment_summary <- matrix(c(overall_treatment_modes_list, overall_treatment_low_ci, overall_treatment_high_ci), 
...
Treatment_table <- data.frame(estimate = overall_treatment_summary[,"Mode"], 
...
density_treatment <- Treatment_table %>% mutate(name = fct_relevel(name, Treatment_Order)) %>%
                     ...
                     label= paste("italic(k)==", c(Treatment_table["Water Level", "K"], 
                                  ...
                                  ")"), parse = TRUE, hjust = "right", size = 3.5) +
                     geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_treatment_waterlevel))-1)*100, 2), nsmall = 2), "%"), 
                                            paste(format(round(posterior.mode(exp(as.mcmc(b_abs_treatment_temperature))-1)*100, 2), nsmall = 2), "%"),
                                            paste(format(round(posterior.mode(exp(as.mcmc(b_abs_treatment_salinity))-1)*100, 2), nsmall = 2), "%"), 
                                            paste(format(round(posterior.mode(exp(as.mcmc(b_abs_treatment_predator))-1)*100, 2), nsmall = 2), "%"), 
                                            paste(format(round(posterior.mode(exp(as.mcmc(b_abs_treatment_humidity))-1)*100, 2), nsmall = 2), "%"),
...
Treatment_table_1 <- data.frame(estimate = overall_treatment_summary_Reorder_1[,"Mode"], 
...
density_treatment_1 <- Treatment_table_1 %>% mutate(name = fct_relevel(name, Treatment_Order_1)) %>%
                       ...
                       label= paste("italic(k)==", c(Treatment_table_1["Predator", "K"], 
                                    ...
                                    ")"), parse = TRUE, hjust = "right", size = 3.5) +
                       geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_treatment_predator))-1)*100, 2), nsmall = 2), "%"), 
                                              paste(format(round(posterior.mode(exp(as.mcmc(b_abs_treatment_humidity))-1)*100, 2), nsmall = 2), "%"),
                                              paste(format(round(posterior.mode(exp(as.mcmc(b_abs_treatment_diet))-1)*100, 2), nsmall = 2), "%")), 
...
Treatment_table_2 <- data.frame(estimate = overall_treatment_summary_Reorder_2[,"Mode"], 
...
mode_abs_b_terrestrial <- posterior.mode(as.mcmc(b_abs_terrestrial))
...
mode_abs_b_terrestrial_plastic_acc <- posterior.mode(as.mcmc(b_abs_terrestrial_plastic_acc))
mode_abs_b_terrestrial_plastic_dev <- posterior.mode(as.mcmc(b_abs_terrestrial_plastic_dev))
...
# Overall_Plasticity_Summary
terrestrial_plastic_modes_list <- c(mode_abs_b_terrestrial_plastic_acc, mode_abs_b_terrestrial_plastic_dev)
...
terrestrial_plastic_summary <- matrix(c(terrestrial_plastic_modes_list, terrestrial_plastic_low_ci, terrestrial_plastic_high_ci), 
...
Terrestrial_Plasticity_table <- data.frame(estimate = terrestrial_plastic_summary[,"Mode"], 
...
Terrestrial_Plasticity_table_1 <- data.frame(estimate = terrestrial_plastic_summary_Reorder_1[,"Mode"], 
...
Terrestrial_Plasticity_table_2 <- data.frame(estimate = terrestrial_plastic_summary_Reorder_2[,"Mode"], 
...
mode_abs_b_terrestrial_trait_behavioural <- posterior.mode(as.mcmc(b_abs_terrestrial_trait_behavioural))
mode_abs_b_terrestrial_trait_biochem <- posterior.mode(as.mcmc(b_abs_terrestrial_trait_biochem))
mode_abs_b_terrestrial_trait_gene <- posterior.mode(as.mcmc(b_abs_terrestrial_trait_gene))
mode_abs_b_terrestrial_trait_morphology <- posterior.mode(as.mcmc(b_abs_terrestrial_trait_morphology))
mode_abs_b_terrestrial_trait_tolerance <- posterior.mode(as.mcmc(b_abs_terrestrial_trait_tolerance))
...
terrestrial_trait_modes_list <- c(mode_abs_b_terrestrial_trait_behavioural, mode_abs_b_terrestrial_trait_biochem, mode_abs_b_terrestrial_trait_gene, 
                                  mode_abs_b_terrestrial_trait_morphology, mode_abs_b_terrestrial_trait_tolerance)
...
terrestrial_trait_summary <- matrix(c(terrestrial_trait_modes_list, terrestrial_trait_low_ci, terrestrial_trait_high_ci), 
                                    nrow = 5, ncol = 3, byrow = FALSE, 
...
Terrestrial_Trait_table <- data.frame(estimate = terrestrial_trait_summary_Reorder[,"Mode"], 
...
density_terrestrial_trait <- Terrestrial_Trait_table %>% mutate(name = fct_relevel(name, Terrestrial_Trait_Order)) %>%
                             ...
                             label= paste("italic(k)==", c(Terrestrial_Trait_table["Tolerance", "K"], 
                                          ...
                                          ")"), parse = TRUE, hjust = "right", size = 3.5) +
                             geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_terrestrial_trait_tolerance))-1)*100, 2), nsmall = 2), "%"), 
                                                    paste(format(round(posterior.mode(exp(as.mcmc(b_abs_terrestrial_trait_morphology))-1)*100, 2), nsmall = 2), "%"), 
                                                    paste(format(round(posterior.mode(exp(as.mcmc(b_abs_terrestrial_trait_gene))-1)*100, 2), nsmall = 2), "%"),
                                                    paste(format(round(posterior.mode(exp(as.mcmc(b_abs_terrestrial_trait_biochem))-1)*100, 2), nsmall = 2), "%"), 
...
Terrestrial_Trait_table_1 <- data.frame(estimate = terrestrial_trait_summary_Reorder_1[,"Mode"], 
...
density_terrestrial_trait_1 <- Terrestrial_Trait_table_1 %>% mutate(name = fct_relevel(name, Terrestrial_Trait_Order_1)) %>%
                               ...
                               label= paste("italic(k)==", c(Terrestrial_Trait_table_1["Gene Expression", "K"], 
                                            ...
                                            ")"), parse = TRUE, hjust = "right", size = 3.5) +
                                geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_terrestrial_trait_gene))-1)*100, 2), nsmall = 2), "%"),
                                                       paste(format(round(posterior.mode(exp(as.mcmc(b_abs_terrestrial_trait_biochem))-1)*100, 2), nsmall = 2), "%"), 
                                                       paste(format(round(posterior.mode(exp(as.mcmc(b_abs_terrestrial_trait_behavioural))-1)*100, 2), nsmall = 2), "%")), 
...
Terrestrial_Trait_table_2 <- data.frame(estimate = terrestrial_trait_summary_Reorder_2[,"Mode"], 
...
mode_abs_b_terrestrial_treatment_humidity <- posterior.mode(as.mcmc(b_abs_terrestrial_treatment_humidity))
mode_abs_b_terrestrial_treatment_temperature <- posterior.mode(as.mcmc(b_abs_terrestrial_treatment_temperature))
...
# Moderator Difference
terres_humid_temp <- as.mcmc(b_abs_terrestrial_treatment_humidity - b_abs_terrestrial_treatment_temperature)
terres_humid_temp_mode <- posterior.mode(terres_humid_temp)
terres_humid_temp_perc <- round(posterior.mode(exp(terres_humid_temp)-1)*100, 2)
terres_humid_temp_ci <- HPDinterval(terres_humid_temp)
terres_humid_temp_p <- 2*(1-max(table(terres_humid_temp<0)/length(terres_humid_temp)))
...
terrestrial_treatment_modes_list <- c(mode_abs_b_terrestrial_treatment_humidity, mode_abs_b_terrestrial_treatment_temperature)
...
terrestrial_treatment_summary <- matrix(c(terrestrial_treatment_modes_list, terrestrial_treatment_low_ci, terrestrial_treatment_high_ci), 
                                    nrow = 2, ncol = 3, byrow = FALSE, 
...
Terrestrial_Treatment_table <- data.frame(estimate = terrestrial_treatment_summary[,"Mode"], 
...
Terrestrial_Treatment_table_1 <- data.frame(estimate = terrestrial_treatment_summary_Reorder_1[,"Mode"], 
...
density_terrestrial_treatment_1 <- Terrestrial_Treatment_table_1 %>% mutate(name = fct_relevel(name, Terrestrial_Treatment_Order_1)) %>%
                                   ...
                                   geom_linerange(aes(y = rev(seq(1, dim(Terrestrial_Treatment_table_1)[1], 1)-0.1), xmin = lowerCL, xmax = upperCL, colour = name),
                                                  size = 1) +
                                   geom_linerange(aes(y = rev(seq(1, dim(Terrestrial_Treatment_table_1)[1], 1)), xmin = max(Terrestrial_Treatment_raw_df_1$Effect)+0.03, xmax = 1.5, colour = name),
                                                  size = 1) +
                                   geom_linerange(aes(y = rev(seq(1, dim(Terrestrial_Treatment_table_1)[1], 1)), xmin = min(Terrestrial_Treatment_raw_df_1$Effect)-0.03, xmax = -0.2, colour = name),
                                                  size = 1) +
...
Terrestrial_Treatment_table_2 <- data.frame(estimate = terrestrial_treatment_summary_Reorder_2[,"Mode"], 
...
mode_abs_b_aquatic <- posterior.mode(as.mcmc(b_abs_aquatic))
...
mode_abs_b_aquatic_plastic_acc <- posterior.mode(as.mcmc(b_abs_aquatic_plastic_acc))
mode_abs_b_aquatic_plastic_dev <- posterior.mode(as.mcmc(b_abs_aquatic_plastic_dev))
mode_abs_b_aquatic_plastic_trans <- posterior.mode(as.mcmc(b_abs_aquatic_plastic_trans))
...
# Overall_Plasticity_Summary
aquatic_plastic_modes_list <- c(mode_abs_b_aquatic_plastic_acc, mode_abs_b_aquatic_plastic_dev, 
                                mode_abs_b_aquatic_plastic_trans)
...
aquatic_plastic_summary <- matrix(c(aquatic_plastic_modes_list, aquatic_plastic_low_ci, aquatic_plastic_high_ci), 
                                  nrow = 3, ncol = 3, byrow = FALSE, 
...
Aquatic_Plasticity_table <- data.frame(estimate = aquatic_plastic_summary[,"Mode"], 
...
Aquatic_Plasticity_table_1 <- data.frame(estimate = aquatic_plastic_summary_Reorder_1[,"Mode"], 
...
Aquatic_Plasticity_table_2 <- data.frame(estimate = aquatic_plastic_summary_Reorder_2[,"Mode"], 
...
mean_abs_b_aquatic_trait_tolerance <- mean(b_abs_aquatic_trait_tolerance)
mode_abs_b_aquatic_trait_biochem <- posterior.mode(as.mcmc(b_abs_aquatic_trait_biochem))
mode_abs_b_aquatic_trait_life <- posterior.mode(as.mcmc(b_abs_aquatic_trait_life))
mode_abs_b_aquatic_trait_morphology <- posterior.mode(as.mcmc(b_abs_aquatic_trait_morphology))
mode_abs_b_aquatic_trait_physiological <- posterior.mode(as.mcmc(b_abs_aquatic_trait_physiological))
mode_abs_b_aquatic_trait_tolerance <- posterior.mode(as.mcmc(b_abs_aquatic_trait_tolerance))
...
ci.abs_aquatic_tolerance <- HPDinterval(as.mcmc(b_abs_aquatic_trait_tolerance))

# Moderator Differences
aqua_phys_bio <- as.mcmc(b_abs_aquatic_trait_physiological - b_abs_aquatic_trait_biochem)
aqua_phys_bio_mode <- posterior.mode(aqua_phys_bio)
aqua_phys_bio_perc <- round(posterior.mode(exp(aqua_phys_bio)-1)*100, 2)
aqua_phys_bio_ci <- HPDinterval(aqua_phys_bio)
aqua_phys_bio_p <- 2*(1-max(table(aqua_phys_bio<0)/length(aqua_phys_bio)))

aqua_phys_life <- as.mcmc(b_abs_aquatic_trait_physiological - b_abs_aquatic_trait_life)
aqua_phys_life_mode <- posterior.mode(aqua_phys_life)
aqua_phys_life_perc <- round(posterior.mode(exp(aqua_phys_life)-1)*100, 2)
aqua_phys_life_ci <- HPDinterval(aqua_phys_life)
aqua_phys_life_p <- 2*(1-max(table(aqua_phys_life<0)/length(aqua_phys_life)))

aqua_phys_morph <- as.mcmc(b_abs_aquatic_trait_physiological - b_abs_aquatic_trait_morphology)
aqua_phys_morph_mode <- posterior.mode(aqua_phys_morph)
aqua_phys_morph_perc <- round(posterior.mode(exp(aqua_phys_morph)-1)*100, 2)
aqua_phys_morph_ci <- HPDinterval(aqua_phys_morph)
aqua_phys_morph_p <- 2*(1-max(table(aqua_phys_morph<0)/length(aqua_phys_morph)))

aqua_phys_tol <- as.mcmc(b_abs_aquatic_trait_physiological - b_abs_aquatic_trait_tolerance)
aqua_phys_tol_mode <- posterior.mode(aqua_phys_tol)
aqua_phys_tol_perc <- round(posterior.mode(exp(aqua_phys_tol)-1)*100, 2)
aqua_phys_tol_ci <- HPDinterval(aqua_phys_tol)
aqua_phys_tol_p <- 2*(1-max(table(aqua_phys_tol<0)/length(aqua_phys_tol)))
...
aquatic_trait_modes_list <- c(mode_abs_b_aquatic_trait_biochem, mode_abs_b_aquatic_trait_life, 
                              mode_abs_b_aquatic_trait_morphology, mode_abs_b_aquatic_trait_physiological, 
                              mode_abs_b_aquatic_trait_tolerance)
...
aquatic_trait_summary <- matrix(c(aquatic_trait_modes_list, aquatic_trait_low_ci, aquatic_trait_high_ci), 
                                  nrow = 5, ncol = 3, byrow = FALSE, 
...
Aquatic_Trait_table <- data.frame(estimate = aquatic_trait_summary_Reorder[,"Mode"], 
...
density_aquatic_trait <- Aquatic_Trait_table %>% mutate(name = fct_relevel(name, Aquatic_Trait_Order)) %>%
                         ...
                         label= paste("italic(k)==", c(Aquatic_Trait_table["Tolerance", "K"], 
                                      ...
                                      ")"), parse = TRUE, hjust = "right", size = 3.5) +
                         geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic_trait_tolerance))-1)*100, 2), nsmall = 2), "%"), 
                                                paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic_trait_physiological))-1)*100, 2), nsmall = 2), "%"), 
                                                paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic_trait_morphology))-1)*100, 2), nsmall = 2), "%"),
                                                paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic_trait_life))-1)*100, 2), nsmall = 2), "%"), 
...
Aquatic_Trait_table_1 <- data.frame(estimate = aquatic_trait_summary_Reorder_1[,"Mode"], 
...
density_aquatic_trait_1 <- Aquatic_Trait_table_1 %>% mutate(name = fct_relevel(name, Aquatic_Trait_Order_1)) %>%
                           ...
                           label= paste("italic(k)==", c(Aquatic_Trait_table_1["Morphological", "K"], 
                                        ...
                                        ")"), parse = TRUE, hjust = "right", size = 3.5) +
                            geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic_trait_morphology))-1)*100, 2), nsmall = 2), "%"),
                                                   paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic_trait_life))-1)*100, 2), nsmall = 2), "%"), 
                                                   paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic_trait_biochem))-1)*100, 2), nsmall = 2), "%")), 
...
Aquatic_Trait_table_2 <- data.frame(estimate = aquatic_trait_summary_Reorder_2[,"Mode"], 
...
density_aquatic_trait_2 <- Aquatic_Trait_table_2 %>% mutate(name = fct_relevel(name, Aquatic_Trait_Order_2)) %>%
                           ...
                           geom_linerange(aes(y = rev(seq(1, dim(Aquatic_Trait_table_2)[1], 1)), xmin = max(Aquatic_Trait_raw_df_2$Effect)+0.001, xmax = 1.5, colour = name),
                                          size = 1) +
                           geom_linerange(aes(y = rev(seq(1, dim(Aquatic_Trait_table_2)[1], 1)), xmin = min(Aquatic_Trait_raw_df_2$Effect)-0.03, xmax = -0.2, colour = name),
                                          size = 1) +
...
mode_abs_b_aquatic_treatment_diet <- posterior.mode(as.mcmc(b_abs_aquatic_treatment_diet))
mode_abs_b_aquatic_treatment_predator <- posterior.mode(as.mcmc(b_abs_aquatic_treatment_predator))
mode_abs_b_aquatic_treatment_salinity <- posterior.mode(as.mcmc(b_abs_aquatic_treatment_salinity))
mode_abs_b_aquatic_treatment_temperature <- posterior.mode(as.mcmc(b_abs_aquatic_treatment_temperature))
mode_abs_b_aquatic_treatment_waterlevel <- posterior.mode(as.mcmc(b_abs_aquatic_treatment_waterlevel))
...
aquatic_treatment_modes_list <- c(mode_abs_b_aquatic_treatment_diet, mode_abs_b_aquatic_treatment_predator,
                                  mode_abs_b_aquatic_treatment_salinity, mode_abs_b_aquatic_treatment_temperature,
                                  mode_abs_b_aquatic_treatment_waterlevel)
...
aquatic_treatment_summary <- matrix(c(aquatic_treatment_modes_list, aquatic_treatment_low_ci, aquatic_treatment_high_ci), 
                                    nrow = 5, ncol = 3, byrow = FALSE, 
...
Aquatic_Treatment_table <- data.frame(estimate = aquatic_treatment_summary[,"Mode"], 
...
density_aquatic_treatment <- Aquatic_Treatment_table %>% mutate(name = fct_relevel(name, Aquatic_Treatment_Order)) %>%
                             ...
                             label= paste("italic(k)==", c(Aquatic_Treatment_table["Water Level", "K"], 
                                          ...
                                          ")"), parse = TRUE, hjust = "right", size = 3.5) +
                             geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic_treatment_waterlevel))-1)*100, 2), nsmall = 2), "%"), 
                                                    paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic_treatment_temperature))-1)*100, 2), nsmall = 2), "%"),
                                                    paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic_treatment_salinity))-1)*100, 2), nsmall = 2), "%"),
                                                    paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic_treatment_predator))-1)*100, 2), nsmall = 2), "%"),
...
Aquatic_Treatment_table_1 <- data.frame(estimate = aquatic_treatment_summary_Reorder_1[,"Mode"], 
...
density_aquatic_treatment_1 <- Aquatic_Treatment_table_1 %>% mutate(name = fct_relevel(name, Aquatic_Treatment_Order_1)) %>%
                               ...
                               label= paste("italic(k)==", c(Aquatic_Treatment_table_1["Salinity", "K"],
                                            ...
                                            ")"), parse = TRUE, hjust = "right", size = 3.5) +
                                geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic_treatment_salinity))-1)*100, 2), nsmall = 2), "%"),
                                                       paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic_treatment_predator))-1)*100, 2), nsmall = 2), "%"),
                                                       paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic_treatment_diet))-1)*100, 2), nsmall = 2), "%")), 
...
Aquatic_Treatment_table_2 <- data.frame(estimate = aquatic_treatment_summary_Reorder_2[,"Mode"], 
...
mode_abs_b_temperature <- posterior.mode(as.mcmc(b_abs_temperature))
...
mode_abs_b_temperature_plastic_acc <- posterior.mode(as.mcmc(b_abs_temperature_plastic_acc))
mode_abs_b_temperature_plastic_dev <- posterior.mode(as.mcmc(b_abs_temperature_plastic_dev))
mode_abs_b_temperature_plastic_trans <- posterior.mode(as.mcmc(b_abs_temperature_plastic_trans))
...
# Overall_Plasticity_Summary
temperature_plastic_modes_list <- c(mode_abs_b_temperature_plastic_acc, mode_abs_b_temperature_plastic_dev, 
                                    mode_abs_b_temperature_plastic_trans)
...
temperature_plastic_summary <- matrix(c(temperature_plastic_modes_list, temperature_plastic_low_ci, temperature_plastic_high_ci), 
                                      nrow = 3, ncol = 3, byrow = FALSE, 
...
Temperature_Plasticity_table <- data.frame(estimate = temperature_plastic_summary[,"Mode"], 
...
density_temperature_plasticity <- Temperature_Plasticity_table %>% mutate(name = fct_relevel(name, Temperature_Plasticity_Order)) %>%
                                  ...
                                  geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_temperature_plastic_trans))-1)*100, 2), nsmall = 2), "%"), 
                                                         paste(format(round(posterior.mode(exp(as.mcmc(b_abs_temperature_plastic_dev))-1)*100, 2), nsmall = 2), "%"),
...
Temperature_Plasticity_table_1 <- data.frame(estimate = temperature_plastic_summary_Reorder_1[,"Mode"], 
...
density_temperature_plasticity_1 <- Temperature_Plasticity_table_1 %>% mutate(name = fct_relevel(name, Temperature_Plasticity_Order_1)) %>%
                                    ...
                                    label= paste("italic(k)==", c(Temperature_Plasticity_table_1["Developmental Plasticity", "K"], 
                                                 ...
                                                 ")"), parse = TRUE, hjust = "right", size = 3.5) +
                                    geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_temperature_plastic_dev))-1)*100, 2), nsmall = 2), "%"),
                                                           paste(format(round(posterior.mode(exp(as.mcmc(b_abs_temperature_plastic_acc))-1)*100, 2), nsmall = 2), "%")), 
...
Temperature_Plasticity_table_2 <- data.frame(estimate = temperature_plastic_summary_Reorder_2[,"Mode"], 
...
mode_abs_b_temperature_trait_behavioural <- posterior.mode(as.mcmc(b_abs_temperature_trait_behavioural))
mode_abs_b_temperature_trait_biochem <- posterior.mode(as.mcmc(b_abs_temperature_trait_biochem))
mode_abs_b_temperature_trait_morphology <- posterior.mode(as.mcmc(b_abs_temperature_trait_morphology))
mode_abs_b_temperature_trait_tolerance <- posterior.mode(as.mcmc(b_abs_temperature_trait_tolerance))
...
temperature_trait_modes_list <- c(mode_abs_b_temperature_trait_behavioural, mode_abs_b_temperature_trait_biochem, 
                                  mode_abs_b_temperature_trait_morphology, mode_abs_b_temperature_trait_tolerance)
...
temperature_trait_summary <- matrix(c(temperature_trait_modes_list, temperature_trait_low_ci, temperature_trait_high_ci), 
...
Temperature_Trait_table <- data.frame(estimate = temperature_trait_summary_Reorder[,"Mode"], 
...
density_temperature_trait <- Temperature_Trait_table %>% mutate(name = fct_relevel(name, Temperature_Trait_Order)) %>%
                             ...
                             label= paste("italic(k)==", c(Temperature_Trait_table["Tolerance", "K"], 
                                          ...
                                          ")"), parse = TRUE, hjust = "right", size = 3.5) +
                             geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_temperature_trait_tolerance))-1)*100, 2), nsmall = 2), "%"), 
                                                    paste(format(round(posterior.mode(exp(as.mcmc(b_abs_temperature_trait_morphology))-1)*100, 2), nsmall = 2), "%"), 
                                                    paste(format(round(posterior.mode(exp(as.mcmc(b_abs_temperature_trait_biochem))-1)*100, 2), nsmall = 2), "%"), 
...
Temperature_Trait_table_1 <- data.frame(estimate = temperature_trait_summary_Reorder_1[,"Mode"], 
...
density_temperature_trait_1 <- Temperature_Trait_table_1 %>% mutate(name = fct_relevel(name, Temperature_Trait_Order_1)) %>%
                               ...
                               label= paste("italic(k)==", c(Temperature_Trait_table_1["Biochemical Assay", "K"], 
                                            ...
                                            ")"), parse = TRUE, hjust = "right", size = 3.5) +
                                geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_temperature_trait_biochem))-1)*100, 2), nsmall = 2), "%"), 
                                                       paste(format(round(posterior.mode(exp(as.mcmc(b_abs_temperature_trait_behavioural))-1)*100, 2), nsmall = 2), "%")), 
...
Temperature_Trait_table_2 <- data.frame(estimate = temperature_trait_summary_Reorder_2[,"Mode"], 
...
mode_abs_b_temperature_taxonomy_actinopteri <- posterior.mode(as.mcmc(b_abs_temperature_taxonomy_actinopteri))
mode_abs_b_temperature_taxonomy_insecta <- posterior.mode(as.mcmc(b_abs_temperature_taxonomy_insecta))
...
# Overall_trait_summary
temperature_taxonomy_modes_list <- c(mode_abs_b_temperature_taxonomy_actinopteri, mode_abs_b_temperature_taxonomy_insecta)
...
temperature_taxonomy_summary <- matrix(c(temperature_taxonomy_modes_list, temperature_taxonomy_low_ci, 
...
Temperature_Taxonomy_table <- data.frame(estimate = temperature_taxonomy_summary[,"Mode"], 
...
Temperature_Taxonomy_table_1 <- data.frame(estimate = temperature_taxonomy_summary_Reorder_1[,"Mode"], 
...
Temperature_Taxonomy_table_2 <- data.frame(estimate = temperature_taxonomy_summary_Reorder_2[,"Mode"], 
...
mode_abs_b_terrestrial_temperature <- posterior.mode(as.mcmc(b_abs_terrestrial_temperature))
...
mode_abs_b_terrestrial_temperature_plastic_acc <- posterior.mode(as.mcmc(b_abs_terrestrial_temperature_plastic_acc))
mode_abs_b_terrestrial_temperature_plastic_dev <- posterior.mode(as.mcmc(b_abs_terrestrial_temperature_plastic_dev))
...
# Overall_Plasticity_Summary
terrestrial_temperature_plastic_modes_list <- c(mode_abs_b_terrestrial_temperature_plastic_acc, mode_abs_b_terrestrial_temperature_plastic_dev)
...
terrestrial_temperature_plastic_summary <- matrix(c(terrestrial_temperature_plastic_modes_list, terrestrial_temperature_plastic_low_ci, terrestrial_temperature_plastic_high_ci), 
                                                  nrow = 2, ncol = 3, byrow = FALSE, 
...
Terrestrial_Temperature_Plasticity_table <- data.frame(estimate = terrestrial_temperature_plastic_summary[,"Mode"], 
...
density_terrestrial_temperature_plasticity <- Terrestrial_Temperature_Plasticity_table %>% mutate(name = fct_relevel(name, Terrestrial_Temperature_Plasticity_Order)) %>%
                                              ...
                                              geom_linerange(aes(y = rev(seq(1, dim(Terrestrial_Temperature_Plasticity_table)[1], 1)), xmin = max(Terrestrial_Temperature_Plasticity_raw_df$Effect)+0.001, xmax = 1.5, colour = name),
                                                             size = 1) +
                                              geom_linerange(aes(y = rev(seq(1, dim(Terrestrial_Temperature_Plasticity_table)[1], 1)), xmin = min(Terrestrial_Temperature_Plasticity_raw_df$Effect)-0.01, xmax = -0.2, colour = name),
                                                             size = 1) +
...
Terrestrial_Temperature_Plasticity_table_1 <- data.frame(estimate = terrestrial_temperature_plastic_summary_Reorder_1[,"Mode"], 
...
density_terrestrial_temperature_plasticity_1 <- Terrestrial_Temperature_Plasticity_table_1 %>% mutate(name = fct_relevel(name, Terrestrial_Temperature_Plasticity_Order_1)) %>%
                                                ...
                                                geom_linerange(aes(y = rev(seq(1, dim(Terrestrial_Temperature_Plasticity_table_1)[1], 1)), xmin = max(Terrestrial_Temperature_Plasticity_raw_df_1$Effect)+0.001, xmax = 1.5, colour = name),
                                                               size = 1) +
                                                geom_linerange(aes(y = rev(seq(1, dim(Terrestrial_Temperature_Plasticity_table_1)[1], 1)), xmin = min(Terrestrial_Temperature_Plasticity_raw_df_1$Effect)-0.01, xmax = -0.2, colour = name),
                                                               size = 1) +
...
Terrestrial_Temperature_Plasticity_table_2 <- data.frame(estimate = terrestrial_temperature_plastic_summary_Reorder_2[,"Mode"], 
...
density_terrestrial_temperature_plasticity_2 <- Terrestrial_Temperature_Plasticity_table_2 %>% mutate(name = fct_relevel(name, Terrestrial_Temperature_Plasticity_Order_2)) %>%
                                                ...
                                                geom_linerange(aes(y = rev(seq(1, dim(Terrestrial_Temperature_Plasticity_table_2)[1], 1)), xmin = max(Terrestrial_Temperature_Plasticity_raw_df_2$Effect)+0.001, xmax = 1.5, colour = name),
                                                               size = 1) +
                                                geom_linerange(aes(y = rev(seq(1, dim(Terrestrial_Temperature_Plasticity_table_2)[1], 1)), xmin = min(Terrestrial_Temperature_Plasticity_raw_df_2$Effect)-0.01, xmax = -0.2, colour = name),
                                                               size = 1) +
...
mode_abs_b_terrestrial_temperature_trait_behavioural <- posterior.mode(as.mcmc(b_abs_terrestrial_temperature_trait_behavioural))
mode_abs_b_terrestrial_temperature_trait_biochem <- posterior.mode(as.mcmc(b_abs_terrestrial_temperature_trait_biochem))
mode_abs_b_terrestrial_temperature_trait_morphology <- posterior.mode(as.mcmc(b_abs_terrestrial_temperature_trait_morphology))
mode_abs_b_terrestrial_temperature_trait_tolerance <- posterior.mode(as.mcmc(b_abs_terrestrial_temperature_trait_tolerance))
...
terrestrial_temperature_trait_modes_list <- c(mode_abs_b_terrestrial_temperature_trait_behavioural, mode_abs_b_terrestrial_temperature_trait_biochem,
                                              mode_abs_b_terrestrial_temperature_trait_morphology, mode_abs_b_terrestrial_temperature_trait_tolerance)
...
terrestrial_temperature_trait_summary <- matrix(c(terrestrial_temperature_trait_modes_list, terrestrial_temperature_trait_low_ci, 
...
Terrestrial_Temperature_Trait_table <- data.frame(estimate = terrestrial_temperature_trait_summary_Reorder[,"Mode"], 
...
density_terrestrial_temperature_trait <- Terrestrial_Temperature_Trait_table %>% mutate(name = fct_relevel(name, Terrestrial_Temperature_Trait_Order)) %>%
                                         ...
                                         geom_linerange(aes(y = rev(seq(1, dim(Terrestrial_Temperature_Trait_table)[1], 1)), xmin = max(Terrestrial_Temperature_Trait_raw_df$Effect)+0.001, xmax = 1.5, colour = name),
                                                        size = 1) +
                                         geom_linerange(aes(y = rev(seq(1, dim(Terrestrial_Temperature_Trait_table)[1], 1)), xmin = min(Terrestrial_Temperature_Trait_raw_df$Effect)-0.01, xmax = -0.2, colour = name),
                                                        size = 1) +
                                         ...
                                         label= paste("italic(k)==", c(Terrestrial_Temperature_Trait_table["Tolerance", "K"], 
                                                      ...
                                                      ")"), parse = TRUE, hjust = "right", size = 3.5) +
                                         geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_terrestrial_temperature_trait_tolerance))-1)*100, 2), nsmall = 2), "%"), 
                                                                paste(format(round(posterior.mode(exp(as.mcmc(b_abs_terrestrial_temperature_trait_morphology))-1)*100, 2), nsmall = 2), "%"), 
                                                                paste(format(round(posterior.mode(exp(as.mcmc(b_abs_terrestrial_temperature_trait_biochem))-1)*100, 2), nsmall = 2), "%"), 
...
Terrestrial_Temperature_Trait_table_1 <- data.frame(estimate = terrestrial_temperature_trait_summary_Reorder_1[,"Mode"], 
...
density_terrestrial_temperature_trait_1 <- Terrestrial_Temperature_Trait_table_1 %>% mutate(name = fct_relevel(name, Terrestrial_Temperature_Trait_Order_1)) %>%
                                           ...
                                           geom_linerange(aes(y = rev(seq(1, dim(Terrestrial_Temperature_Trait_table_1)[1], 1)), xmin = max(Terrestrial_Temperature_Trait_raw_df_1$Effect)+0.001, xmax = 1.5, colour = name),
                                                          size = 1) +
                                           geom_linerange(aes(y = rev(seq(1, dim(Terrestrial_Temperature_Trait_table_1)[1], 1)), xmin = min(Terrestrial_Temperature_Trait_raw_df_1$Effect)-0.01, xmax = -0.2, colour = name),
                                                          size = 1) +
                                           ...
                                           label= paste("italic(k)==", c(Terrestrial_Temperature_Trait_table_1["Biochemical Assay", "K"], 
                                                        ...
                                                        ")"), parse = TRUE, hjust = "right", size = 3.5) +
                                            geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_terrestrial_temperature_trait_biochem))-1)*100, 2), nsmall = 2), "%"), 
                                                                   paste(format(round(posterior.mode(exp(as.mcmc(b_abs_terrestrial_temperature_trait_behavioural))-1)*100, 2), nsmall = 2), "%")), 
...
Terrestrial_Temperature_Trait_table_2 <- data.frame(estimate = terrestrial_temperature_trait_summary_Reorder_2[,"Mode"], 
...
density_terrestrial_temperature_trait_2 <- Terrestrial_Temperature_Trait_table_2 %>% mutate(name = fct_relevel(name, Terrestrial_Temperature_Trait_Order_2)) %>%
                                           ...
                                           geom_linerange(aes(y = rev(seq(1, dim(Terrestrial_Temperature_Trait_table_2)[1], 1)), xmin = max(Terrestrial_Temperature_Trait_raw_df_2$Effect)+0.001, xmax = 1.5, colour = name),
                                                          size = 1) +
                                           geom_linerange(aes(y = rev(seq(1, dim(Terrestrial_Temperature_Trait_table_2)[1], 1)), xmin = min(Terrestrial_Temperature_Trait_raw_df_2$Effect)-0.01, xmax = -0.2, colour = name),
                                                          size = 1) +
...
mode_abs_b_aquatic_temperature <- posterior.mode(as.mcmc(b_abs_aquatic_temperature))
...
mode_abs_b_aquatic_temperature_plastic <- posterior.mode(as.mcmc(b_abs_aquatic_temperature_plastic))
...
aquatic_temperature_plasticity_modes_list <- c(mode_abs_b_aquatic_temperature_plastic)
...
aquatic_temperature_plasticity_summary <- matrix(c(aquatic_temperature_plasticity_modes_list, aquatic_temperature_plasticity_low_ci, 
...
Aquatic_Temperature_Plasticity_table <- data.frame(estimate = aquatic_temperature_plasticity_summary[,"Mode"], 
...
mode_abs_b_aquatic_temperature_trait_biochem <- posterior.mode(as.mcmc(b_abs_aquatic_temperature_trait_biochem))
mode_abs_b_aquatic_temperature_trait_tolerance <- posterior.mode(as.mcmc(b_abs_aquatic_temperature_trait_tolerance))
...
aquatic_temperature_trait_modes_list <- c(mode_abs_b_aquatic_temperature_trait_biochem, mode_abs_b_aquatic_temperature_trait_tolerance)
...
aquatic_temperature_trait_summary <- matrix(c(aquatic_temperature_trait_modes_list, aquatic_temperature_trait_low_ci, 
...
Aquatic_Temperature_Trait_table <- data.frame(estimate = aquatic_temperature_trait_summary[,"Mode"], 
...
Aquatic_Temperature_Trait_table_1 <- data.frame(estimate = aquatic_temperature_trait_summary_Reorder_1[,"Mode"], 
...
Aquatic_Temperature_Trait_table_2 <- data.frame(estimate = aquatic_temperature_trait_summary_Reorder_2[,"Mode"], 
...
mode_abs_b_aquatic_salinity <- posterior.mode(as.mcmc(b_abs_aquatic_salinity))
...
mode_abs_b_aquatic_salinity_plastic <- posterior.mode(as.mcmc(b_abs_aquatic_salinity_plastic))
...
aquatic_salinity_plasticity_modes_list <- c(mode_abs_b_aquatic_salinity_plastic)
...
aquatic_salinity_plasticity_summary <- matrix(c(aquatic_salinity_plasticity_modes_list, aquatic_salinity_plasticity_low_ci, 
...
Aquatic_Salinity_Plasticity_table <- data.frame(estimate = aquatic_salinity_plasticity_summary[,"Mode"], 
...
mode_abs_b_aquatic_salinity_trait <- posterior.mode(as.mcmc(b_abs_aquatic_salinity_trait))
...
aquatic_salinity_trait_modes_list <- c(mode_abs_b_aquatic_salinity_trait)
...
aquatic_salinity_trait_summary <- matrix(c(aquatic_salinity_trait_modes_list, aquatic_salinity_trait_low_ci, 
...
Aquatic_Salinity_Trait_table <- data.frame(estimate = aquatic_salinity_trait_summary[,"Mode"], 
...
Intercept_modes_df <- data.frame("Mean" = c(mode_abs_b, 
                                            mode_abs_b_terrestrial, 
                                            mode_abs_b_aquatic,
                                            mode_abs_b_temperature, 
                                            mode_abs_b_terrestrial_temperature, 
                                            mode_abs_b_aquatic_temperature,
                                            mode_abs_b_aquatic_salinity), 
...
Intercept_table <- data.frame(estimate = Intercept_modes_df[,1], 
...
density_intercept <- Intercept_table %>% mutate(name = fct_relevel(name, Intercept_Order)) %>%
                     ...
                     label= paste("italic(k)==", c(Intercept_table["Aquatic and Salinity", "K"], 
                                  ...
                                  ")"), parse = TRUE, hjust = "right", size = 3.5) +
                     geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic_salinity))-1)*100, 2), nsmall = 2), "%"), 
                                            paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic_temperature))-1)*100, 2), nsmall = 2), "%"),
                                            paste(format(round(posterior.mode(exp(as.mcmc(b_abs_terrestrial_temperature))-1)*100, 2), nsmall = 2), "%"), 
                                            paste(format(round(posterior.mode(exp(as.mcmc(b_abs_temperature))-1)*100, 2), nsmall = 2), "%"), 
                                            paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic))-1)*100, 2), nsmall = 2), "%"), 
                                            paste(format(round(posterior.mode(exp(as.mcmc(b_abs_terrestrial))-1)*100, 2), nsmall = 2), "%"), 
...
Intercept_modes_df_1 <- data.frame("Mean" = c(mode_abs_b, 
                                              mode_abs_b_terrestrial, 
                                              mode_abs_b_aquatic), 
...
Intercept_table_1 <- data.frame(estimate = Intercept_modes_df_1[,1], 
...
density_intercept_1 <- Intercept_table_1 %>% mutate(name = fct_relevel(name, Intercept_Order_1)) %>%
                       ...
                       label= paste("italic(k)==", c(Intercept_table_1["Aquatic", "K"], 
                                    ...
                                    ")"), parse = TRUE, hjust = "right", size = 3.5) +
                        geom_label(aes(label=c(paste(format(round(posterior.mode(exp(as.mcmc(b_abs_aquatic))-1)*100, 2), nsmall = 2), "%"), 
                                               paste(format(round(posterior.mode(exp(as.mcmc(b_abs_terrestrial))-1)*100, 2), nsmall = 2), "%"), 
                                               paste(format(round(posterior.mode(exp(as.mcmc(b_abs))-1)*100, 2), nsmall = 2), "%")), 
...
Intercept_modes_df_2 <- data.frame("Mean" = c(mode_abs_b_temperature, 
                                              mode_abs_b_terrestrial_temperature, 
                                              mode_abs_b_aquatic_temperature,
                                              mode_abs_b_aquatic_salinity), 
...
Intercept_table_2 <- data.frame(estimate = Intercept_modes_df_2[,1], 
...
Raw_Plasticity <- data.frame("Plasticity Category" = c("Acclimation", "Developmental Plasticity", "Transgenerational Effects"), 
                             ...
                             "Estimate" = c(mode_abs_b_plastic_acc, mode_abs_b_plastic_dev, mode_abs_b_plastic_trans), 
...
Raw_Trait <- data.frame("Phenotypic Trait Categories" = c("Behavioural", "Biochemical Assay", "Gene Expression", "Life-History Traits", 
                        ...
                        "Estimate" = c(mode_abs_b_trait_behavioural, mode_abs_b_trait_biochem, 
                                       mode_abs_b_trait_gene, mode_abs_b_trait_life, 
                                       mode_abs_b_trait_morphology, mode_abs_b_trait_physiological, 
                                       mode_abs_b_trait_tolerance), 
...
Raw_Taxonomy <- data.frame("Taxonomic Class" = c("Actinopteri", "Amphibia", "Branchiopoda", 
                           ...
                           "Estimate" = c(mode_abs_b_taxonomy_actinopteri, mode_abs_b_taxonomy_amphibia, 
                                          mode_abs_b_taxonomy_branchiopoda, mode_abs_b_taxonomy_gastropoda, 
                                          mode_abs_b_taxonomy_insecta), 
...
Raw_Treatment <- data.frame("Treatment Type" = c("Diet", "Humidity", "Predator", 
                            ...
                            "Estimate" = c(mode_abs_b_treatment_diet, mode_abs_b_treatment_humidity, 
                                           mode_abs_b_treatment_predator, mode_abs_b_treatment_salinity, 
                                           mode_abs_b_treatment_temperature, mode_abs_b_treatment_waterlevel), 
...
Raw_Terrestrial <- data.frame("Terrestrial" = c("MLMA"), 
                              ...
                              "Estimate" = c(mode_abs_b_terrestrial),
...
Raw_Terrestrial_Plasticity <- data.frame("Plasticity Category" = c("Acclimation", "Developmental Plasticity"), 
                                         ...
                                         "Estimate" = c(mode_abs_b_terrestrial_plastic_acc, mode_abs_b_terrestrial_plastic_dev), 
...
Raw_Terrestrial_Trait <- data.frame("Phenotypic Trait Categories" = c("Behavioural", "Biochemical Assay", "Gene Expression", 
                                    ...
                                    "Estimate" = c(mode_abs_b_terrestrial_trait_behavioural, mode_abs_b_terrestrial_trait_biochem, 
                                                   mode_abs_b_terrestrial_trait_gene, mode_abs_b_terrestrial_trait_morphology,
                                                   mode_abs_b_terrestrial_trait_tolerance), 
...
Raw_Terrestrial_Treatment <- data.frame("Treatment Type" = c("Humidity", "Temperature"), 
                                        ...
                                        "Estimate" = c(mode_abs_b_terrestrial_treatment_humidity, mode_abs_b_terrestrial_treatment_temperature), 
...
Raw_Aquatic_Plasticity <- data.frame("Plasticity Category" = c("Acclimation", "Developmental Plasticity", "Transgenerational Effects"), 
                                     ...
                                     "Estimate" = c(mode_abs_b_aquatic_plastic_acc, mode_abs_b_aquatic_plastic_dev, 
                                                    mode_abs_b_aquatic_plastic_trans), 
...
Raw_Aquatic_Trait <- data.frame("Phenotypic Trait Categories" = c("Biochemical Assay", "Life-History Traits", "Morphology", 
                                ...
                                "Estimate" = c(mode_abs_b_aquatic_trait_biochem, mode_abs_b_aquatic_trait_life, 
                                               mode_abs_b_aquatic_trait_morphology, mode_abs_b_aquatic_trait_physiological,
                                               mode_abs_b_aquatic_trait_tolerance), 
...
Raw_Aquatic_Treatment <- data.frame("Treatment Type" = c("Diet", "Predator", "Salinity", "Temperature", "Water Level"), 
                                    ...
                                    "Estimate" = c(mode_abs_b_aquatic_treatment_diet, mode_abs_b_aquatic_treatment_predator, 
                                                   mode_abs_b_aquatic_treatment_salinity, mode_abs_b_aquatic_treatment_temperature, 
                                                   mode_abs_b_aquatic_treatment_waterlevel), 
...
Raw_Temperature <- data.frame("Temperature" = c("MLMA"),
                              ...
                              "Estimate" = c(mode_abs_b_temperature),
...
Raw_Temperature_Plasticity <- data.frame("Plasticity Category" = c("Acclimation", "Developmental Plasticity", "Transgenerational Effects"), 
                                         ...
                                         "Estimate" = c(mode_abs_b_temperature_plastic_acc, mode_abs_b_temperature_plastic_dev, mode_abs_b_temperature_plastic_trans), 
...
Raw_Temperature_Trait <- data.frame("Phenotypic Trait Categories" = c("Behavioural", "Biochemical Assay", 
                                    ...
                                    "Estimate" = c(mode_abs_b_temperature_trait_behavioural, mode_abs_b_temperature_trait_biochem, 
                                                   mode_abs_b_temperature_trait_morphology, mode_abs_b_temperature_trait_tolerance), 
...
Raw_Temperature_Taxonomy <- data.frame("Taxonomic Class" = c("Actinopteri", "Insecta"), 
                                       ...
                                       "Estimate" = c(mode_abs_b_temperature_taxonomy_actinopteri, mode_abs_b_temperature_taxonomy_insecta), 
...
Raw_Terrestrial_Temperature <- data.frame("Terrestrial and Temperature" = c("MLMA"), 
                                          ...
                                          "Estimate" = c(mode_abs_b_terrestrial_temperature),
...
Raw_Terrestrial_Temperature_Plasticity <- data.frame("Plasticity Category" = c("Acclimation", "Developmental Plasticity"), 
                                                     ...
                                                     "Estimate" = c(mode_abs_b_terrestrial_temperature_plastic_acc, 
                                                                    mode_abs_b_terrestrial_temperature_plastic_dev), 
...
Raw_Terrestrial_Temperature_Trait <- data.frame("Phenotypic Trait Categories" = c("Behavioural", "Biochemical Assay",  
                                                ...
                                                "Estimate" = c(mode_abs_b_terrestrial_temperature_trait_behavioural, mode_abs_b_terrestrial_temperature_trait_biochem, 
                                                               mode_abs_b_terrestrial_temperature_trait_morphology, mode_abs_b_terrestrial_temperature_trait_tolerance), 
...
Raw_Aquatic_Temperature <- data.frame("Aquatic and Temperature" = c("MLMA"), 
                                      ...
                                      "Estimate" = c(mode_abs_b_aquatic_temperature),
...
Raw_Aquatic_Temperature_Plasticity <- data.frame("Plasticity Category" = c("Acclimation"), 
                                                 ...
                                                 "Estimate" = c(mode_abs_b_aquatic_temperature_plastic), 
...
Raw_Aquatic_Temperature_Trait <- data.frame("Phenotypic Trait Categories" = c("Biochemical Assay", "Tolerance"), 
                                            ...
                                            "Estimate" = c(mode_abs_b_aquatic_temperature_trait_biochem, 
                                                           mode_abs_b_aquatic_temperature_trait_tolerance), 
...
Raw_Aquatic_Salinity <- data.frame("Aquatic and Salinity" = c("MLMA"), 
                                   ...
                                   "Estimate" = c(mode_abs_b_aquatic_salinity),
...
Raw_Aquatic_Salinity_Plasticity <- data.frame("Plasticity Category" = c("Acclimation"), 
                                              ...
                                              "Estimate" = c(mode_abs_b_aquatic_salinity_plastic), 
...
Raw_Aquatic_Salinity_Trait <- data.frame("Phenotypic Trait Categories" = c("Biochemical Assay"), 
                                         ...
                                         "Estimate" = c(mode_abs_b_aquatic_salinity_trait), 
